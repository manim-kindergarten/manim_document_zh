...
:class:`~manimlib.mobject.svg.tex_mobject.TexMobject` 和 :class:`~manimlib.mobject.svg.tex_mobject.TextMobject`
...
关于 :class:`~manimlib.mobject.svg.tex_mobject.TexMobject` 和 :class:`~manimlib.mobject.svg.tex_mobject.TextMobject`
的区别，还有 ``LaTeX`` 发行版安装和文字字体问题，常见问题中有更详细的解答：

- `manim常见问题：LaTeX问题 <https://manim.wiki/CommonProblems/v2.3.html#latex>`__
- `manim常见问题：中文显示问题 <https://manim.wiki/CommonProblems/v2.3.html#id7>`__
- `manim常见问题：文字问题 <https://manim.wiki/CommonProblems/v2.3.html#id8>`__

MK做了一个关于常用 :class:`~manimlib.mobject.svg.tex_mobject.TexMobject` 和 :class:`~manimlib.mobject.svg.tex_mobject.TextMobject` 的视频：
