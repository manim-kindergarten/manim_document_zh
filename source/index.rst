...
这些文档基于 `3b1b/manim存储库 <https://github.com/3b1b/manim>`_ 的cairo-backend分支（旧版），你可以通过提交pr来为文档做出贡献，详见 `贡献规则及编写指南页面 <https://manim.wiki/contribution>`__

目前包含两大部分， **入门教程** 和 **进阶文档** 。入门教程中还有很多需要完善，进阶文档还需要补充示例。后续可能还会添加 **进阶教程** 部分

针对master分支（新版）的文档在这里：https://manim.wiki/shaders/
